        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (netCheck.checkConnection(getApplicationContext())) {
                    ...
                    if (userType == 1) {
                        utype = "warden";
                        intent = new Intent(MainActivity.this, wardenHome.class);
                    } if(userType == 2) {
                        utype = "student";
                    ...
                    Toast.makeText(MainActivity.this, "You Are Offline  Please Check Your Internet And Retry.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
